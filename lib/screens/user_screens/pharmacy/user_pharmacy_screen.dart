...
class _UserPharmacyScreenState extends State<UserPharmacyScreen> {
  ...
  Widget _buildPharmacyItemCard(Map<String, dynamic> item, CartProvider cartProvider) {
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color: availableQuantity > 0 ? Colors.black : Colors.red,
                    ),
                  ),
                ],
              ),
              ...
              children: [
                ...
                Consumer<CartProvider>(
                  builder: (context, cart, child) {
                    ...
                    int currentAvailable = item['quantity'] - currentCartQuantity;
